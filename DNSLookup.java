/*      DNSLookup Program: Print out DNS Record for an Internet Address       */



import javax.naming.directory.Attributes;
import javax.naming.directory.InitialDirContext;			// for iDirC.getAttributes()
...
public class DNSLookup
{
	public static void main(String args[])
	{
		...
		catch (NamingException | UnknownHostException exception)
		{
